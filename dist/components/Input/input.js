 ...
 * ~~~js
 * // 引用
 * import { Input } from 'ango-react-components'
 * ~~~
...
export var Input = function (props) {
    ...
    var cnames = classNames("ango-input-wrapper", (_a = {},
    ...
    return (React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: "ango-input-group-prepend" }, prepend),
        icon && (React.createElement("div", { className: "icon-wrapper" },
            React.createElement(Icon, { icon: icon, title: "title-" + icon }))),
        React.createElement("input", __assign({ className: "ango-input-inner", disabled: disabled }, restProps)),
        append && React.createElement("div", { className: "ango-input-group-append" }, append)));
};
Input.defaultProps = {
    disabled: false,
    size: "lg",
