...
var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: 'ango-upload-list' }, fileList.map(function (item) {
        return (React.createElement("li", { className: 'ango-upload-list-item', key: item.uid },
